...
let loadButtonWrapper = document.querySelector(".classicmag-load-posts-btn-wrapper");
let loadButton = document.querySelector(
    ".classicmag-load-posts-btn-wrapper .load-btn"
);
let loader = document.querySelector(".classicmag-ajax-loader");
let articleWrapper = document.querySelector(".classicmag-article-wrapper");
    ...
    fetchThePosts: function () {
        ...
        fetch(ClassicmagVars.ajaxurl, {
            ...
            body: new URLSearchParams({
                action: "classicmag_load_posts",
                nonce: ClassicmagVars.nonce,
                query_vars: ClassicmagVars.query_vars,
                page: nextPage,
            }),
        })
            .then((response) => {
