 ...
 * @package Classicmag
 */
if ( ! function_exists( 'classicmag_get_default_customizer_values' ) ) :
	/**
	 ...
	 */
	function classicmag_get_default_customizer_values() {
		...
		$defaults['site_title_text_size'] = 48;
        ...
        $defaults['advertisement_section_title'] = esc_html__('Welcome Advertisement Message', 'classicmag');
        ...
        //newsletter
        $defaults['enable_newsletter']          = true;
        $defaults['newsletter_section_title'] = __('Newsletter Subscription Form', 'classicmag');
        $defaults['newsletter_section_description'] = '';

        // shop page
        $defaults['enable_shop_section']          = true;
        $defaults['shop_post_title'] = __('Shop Now', 'classicmag');
        ...
        $defaults['shop_post_button_text'] = __('Shop Now', 'classicmag');
        ...
        $defaults['related_posts_text'] = __('You May Also Like', 'classicmag');
        ...
        $defaults['author_posts_text'] = __('More From Author', 'classicmag');
        ...
        $defaults['footer_recommended_post_title'] = esc_html__( 'You May Also Like:', 'classicmag' );
        $defaults['enable_category_meta'] = true;
        $defaults['enable_post_excerpt'] = false;
        $defaults['enable_date_meta'] = false;
        ...
        $defaults['copyright_text'] = esc_html__( 'Copyright &copy;', 'classicmag' );
		...
		$defaults = apply_filters( 'classicmag_default_customizer_values', $defaults );
		return $defaults;
	}
endif;