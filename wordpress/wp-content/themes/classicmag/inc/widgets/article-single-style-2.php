...
class Classicmag_Article_Single_Style_2 extends Classicmag_Widget_Base
{
    /**
    ...
    {
        $this->widget_cssclass = 'classicmag_single_article_posts_style_2_widget';
        $this->widget_description = __("Displays post from single category widget", 'classicmag');
        $this->widget_id = 'classicmag-single-article-post-style-2-widget';
        $this->widget_name = __('Classicmag: Single Category Post Style 2', 'classicmag');
        $this->settings = array(
            'title_1' => array(
                'type' => 'text',
                ...
                <div class="column-row">
                    ...
                    if ($classicmag_article_posts_style_query->have_posts()):
                        ...
                        if ($count == 1) { ?>
                            ...
                            <div class="column column-8 column-md-12 column-sm-12 column-order-2">
                                <article class="theme-news-article theme-article-flex">
                                    ...
                                    <div class="theme-article-content">
                                        <div class="theme-article-excerpt theme-drop-cap line-clamp line-clamp-15 mb-16">
                                            <p>
                                                <?php if (has_excerpt()) {
                                                    the_excerpt();
                                                } else {
                    ...
                    <div class="column column-4 column-md-12 column-sm-12 column-order-1">
