...
class Classicmag_Article_Single_Style_3 extends Classicmag_Widget_Base
{
    /**
    ...
    {
        $this->widget_cssclass = 'classicmag_single_article_posts_style_3_widget';
        $this->widget_description = __("Displays post from single category widget", 'classicmag');
        $this->widget_id = 'classicmag-single-article-post-style-3-widget';
        $this->widget_name = __('Classicmag: Single Category Post Style 3', 'classicmag');
        $this->settings = array(
            'title_1' => array(
                'type' => 'text',
                        ...
                        <div class="theme-section-body">
                            <div class="column-row theme-grid-border">
                                ...
                                if ($classicmag_article_posts_style_query->have_posts()):
                                    ...
                                    if ($count == 1) { ?>
                                        <div class="column column-6 column-md-12 md-mb-24 column-sm-12 sm-mb-24">
                                            <article class="theme-news-article">
                                                ...
                                                <div class="theme-article-content">
                                                    <h2 class="entry-title font-size-big line-clamp line-clamp-4 m-0 mb-8">
                                                        <a href="<?php the_permalink(); ?>"> <?php the_title(); ?> </a>
                                                    </h2>

                                                    <div class="theme-article-excerpt line-clamp line-clamp-7 mb-16">
                                                        <?php if (has_excerpt()) {
                                                            the_excerpt();
                                                        } else {
                                                    ...
                                                    <div class="entry-meta entry-meta-bottom">
                                                        <?php classicmag_posted_on(); ?>
                                                    </div>
                                                </div>
                                            </article>
                                        </div>
                                        <div class="column column-3 column-md-6 column-sm-12 sm-mb-24">
                                        <?php $count++; } elseif($count == 2 || $count == 3) { ?>
                                            ...
                                            <article class="theme-news-article theme-border-space border-space-big">
                                                ...
                                                <div class="theme-article-excerpt line-clamp line-clamp-4 mb-16">
                                                    <?php if (has_excerpt()) {
                                                        the_excerpt();
                                                    } else {
                                                        echo esc_html(wp_trim_words( get_the_content(), 40, '...' ));
