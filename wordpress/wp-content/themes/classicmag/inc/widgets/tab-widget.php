...
class Classicmag_Tab_Posts extends Classicmag_Widget_Base
{
    /**
    ...
    {
        $this->widget_cssclass = 'widget_classicmag_tab_posts';
        $this->widget_description = __("Displays Tab Widget", 'classicmag');
        $this->widget_id = 'classicmag_tab_posts';
        $this->widget_name = __('Classicmag: Tab Posts', 'classicmag');
        $this->settings = array(
            'popular_heading' => array(
                'label' => esc_html__('Popular', 'classicmag'),
                'type' => 'heading',
            ),
            'popular_number' => array(
                'label' => esc_html__('No. of Posts:', 'classicmag'),
                'type' => 'number',
                'css' => 'max-width:60px;',
                'default' => 5,
                'min' => 1,
            ...
            'recent_heading' => array(
                'label' => esc_html__('Recent', 'classicmag'),
                'type' => 'heading',
            ),
            'recent_number' => array(
                'label' => esc_html__('No. of Posts:', 'classicmag'),
            ...
            'comments_heading' => array(
                'label' => esc_html__('Comments', 'classicmag'),
                'type' => 'heading',
            ),
            'comments_number' => array(
                'label' => esc_html__('No. of Comments:', 'classicmag'),
                'type' => 'number',
                'css' => 'max-width:60px;',
                'default' => 5,
                'min' => 1,
            ...
            'tagged_heading' => array(
                'label' => esc_html__('Tagged', 'classicmag'),
                'type' => 'heading',
            ),
            'select_image_size' => array(
                'label' => esc_html__('Select Image Size Featured Post:', 'classicmag'),
                'type' => 'select',
                'default' => 'medium',
                'options' => array(
                    'thumbnail' => esc_html__('Thumbnail', 'classicmag'),
                    'medium' => esc_html__('Medium', 'classicmag'),
                    'large' => esc_html__('Large', 'classicmag'),
                    'full' => esc_html__('Full', 'classicmag'),
                ),
            ),
            'style' => array(
                'type' => 'select',
            ...
            'show_date' => array(
                'type' => 'checkbox',
                'label' => __('Show Date', 'classicmag'),
                'std' => true,
            ),
            'date_format' => array(
                'type' => 'select',
                'label' => __('Date Format', 'classicmag'),
                'options' => array(
                    'format_1' => __('Format 1', 'classicmag'),
                    'format_2' => __('Format 2', 'classicmag'),
                ),
                'std' => 'format_1',
            ),
        );
                    ...
                    <li role="presentation" tab-data="tab-popular" class="widget-tab-presentation tab-popular active">
                        <a href="javascript:void(0)" aria-controls="popular" role="tab">
                            <span class="fire-icon tab-icon">
                                <?php classicmag_theme_svg('blaze'); ?>
                            </span>
                        </a>
                    </li>
                        ...
                        <article
                            ...
                            <div class="entry-details">
                                ...
                                if ($instance['show_date']) {
                                    ?>
                                    <div class="classicmag-meta post-date">
                                        ...
                                        <span class="meta-text">
                                            ...
                                            if ('format_1' == $date_format) {
                                                echo esc_html(human_time_diff(get_the_time('U'), current_time('timestamp')) . ' ' . __('ago', 'classicmag'));
                                            } else {
