...
$enable_copyright = classicmag_get_option('enable_copyright');
$enable_footer_nav = classicmag_get_option('enable_footer_nav');
$enable_footer_social_nav = classicmag_get_option('enable_footer_social_nav');
$enable_footer_credit = classicmag_get_option('enable_footer_credit');
            ...
            <div class="theme-author-credit">
                ...
                <?php if($enable_copyright):?>
                    <div class="theme-copyright-info">
                        <?php
                        $copyright_text = classicmag_get_option('copyright_text');
                        if($copyright_text):
                            echo wp_kses_post($copyright_text); 
                        endif;
                        $copyright_date_format = classicmag_get_option( 'copyright_date_format', 'Y' );
                ...
                <?php if($enable_footer_credit): ?>
                    <div class="theme-credit-info">
                        <?php printf(esc_html__('Designed & Developed by %1$s', 'classicmag'), '<a href="https://themeinwp.com/" target = "_blank" rel="designer">ThemeinWP Team</a>'); ?>
                    </div>
