...
$enable_header_bg_overlay = classicmag_get_option('enable_header_bg_overlay');
$header_image_size = classicmag_get_option('header_image_size');
$enable_top_bar = classicmag_get_option('enable_top_bar');
