 ...
 * @package Classicmag
 */
$ed_header_type = classicmag_get_option( 'ed_header_type' );
$upload_add_image = classicmag_get_option( 'upload_add_image' );
$ed_header_link = classicmag_get_option( 'ed_header_link' );
$advertisement_section_title = classicmag_get_option( 'advertisement_section_title' );
?>
            ...
            <header class="welcome-screen-header">
                ...
                <div class="welcome-screen-actions">
                    ...
                    <button type="button" class="welcome-screen-skip">
                        <?php echo esc_html__('Skip This', 'classicmag') ?>
                    </button>
                </div>
            </header>
        <?php } ?>
