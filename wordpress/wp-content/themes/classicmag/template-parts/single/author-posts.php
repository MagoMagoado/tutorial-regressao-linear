...
$author_posts_text = classicmag_get_option('author_posts_text');
$no_of_author_posts = absint(classicmag_get_option('no_of_author_posts'));
$order = esc_attr(classicmag_get_option('author_posts_order'));
$orderby = esc_attr(classicmag_get_option('author_posts_orderby'));
...
if( $author_posts_query->have_posts() ):
    ...
    <div class="single-author-posts-area theme-single-post-component">
        <header class="theme-section-head">
            <h2><?php echo esc_html($author_posts_text);?></h2>
        </header>
