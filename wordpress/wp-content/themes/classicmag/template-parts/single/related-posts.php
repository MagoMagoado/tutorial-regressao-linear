...
$related_posts_text = classicmag_get_option('related_posts_text');
$no_of_related_posts = absint(classicmag_get_option('no_of_related_posts'));
$order = esc_attr(classicmag_get_option('related_posts_order'));
$orderby = esc_attr(classicmag_get_option('related_posts_orderby'));
